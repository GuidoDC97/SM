		...
		if (dateText != null) {
			if (formato == nFormato.Default) {
				...
				if (formatoCustom == "") {
                    ...
                    //dateText.text = DateGlobal.ToString(formatoCustom);
                    dateText.text = inputFieldDate.day.text+"/"+inputFieldDate.month.text + "/" + inputFieldDate.year.text+ " : " + inputFieldTime.hour.text;
                }
			} else{
                dateText.text = inputFieldDate.day.text + "/" + inputFieldDate.month.text + "/" + inputFieldDate.year.text + " : " + inputFieldTime.hour.text;
